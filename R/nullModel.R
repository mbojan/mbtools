...
#'
#' where \eqn{Y_{ij}}{Y_ij} is the value of the dependent variable (\code{y})
...
#'
#' @return The function returns a list of S3 class \code{nullModel} which
...
#' }
#'
#' @seealso \code{\link[lme4]{lmer}} in package \pkg{lme4} for general fitting
